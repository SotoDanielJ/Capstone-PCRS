...
const GamingPostsComponent = () => {
    ...
    const fetchAllPosts = async () => {
        try {
            const response = await axios.get(`http://localhost:8080/api/users/posts/category/0`, { withCredentials: true });
...
export default GamingPostsComponent