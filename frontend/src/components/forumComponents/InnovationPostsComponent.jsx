...
const InnovationPostsComponent = () => {
    ...
    const fetchAllPosts = async () => {
        try {
            const response = await axios.get(`http://localhost:8080/api/users/posts/category/3`, { withCredentials: true });
...
export default InnovationPostsComponent