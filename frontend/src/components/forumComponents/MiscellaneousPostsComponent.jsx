...
const MiscellaneousPostsComponent = () => {
    ...
    const fetchAllPosts = async () => {
        try {
            const response = await axios.get(`http://localhost:8080/api/users/posts/category/5`, { withCredentials: true });
...
export default MiscellaneousPostsComponent