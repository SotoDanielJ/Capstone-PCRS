...
const SoftwarePostsComponent = () => {
    ...
    const fetchAllPosts = async () => {
        try {
            const response = await axios.get(`http://localhost:8080/api/users/posts/category/2`, { withCredentials: true });
    ...
    const postContainer = {
        ...
        flexDirection: 'column',
        alignItems: 'center',
        backgroundImage: 'linear-gradient(to bottom, #9796f0,#FF8E53)',
            ...
            <div style={feedContainer}>
                ...
                {currentPosts.map((post, index) => (
                    <div style={postContainer} key={index}>
                        ...
                        {showViewContent && <ViewContentComponent post={selectedPost} onClick={handleViewCloseButtonClick} />}
...
export default SoftwarePostsComponent