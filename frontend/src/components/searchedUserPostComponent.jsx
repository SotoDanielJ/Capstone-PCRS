...
const SearchedUserPostComponent = ({ searchedUser }) => {
    ...
    const fetchUserPosts = async () => {
        try {
            const response = await axios.get(`http://localhost:8080/api/users/posts/${searchedUser.username}`, { withCredentials: true });
...
export default SearchedUserPostComponent